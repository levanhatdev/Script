...
if not Success then
	warn("\nLe Van Nhat XP - Không thể tải Biểu tượng. Mã lỗi: " .. Response .. "\n")
end	
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if OrionLib.Flags[a] then
			...
			warn("Le Van Nhat XP Trình tải cấu hình - Không thể tìm thấy ", a ,b)
		end
	end)
end
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Le Van Nhat XP"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Le Van Nhat XP"
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		OrionLib:MakeNotification({
			Name = "Thông Báo!",
			Content = "Đã Ẩn Giao Diện Thành Công!",
			Time = 5
		})
