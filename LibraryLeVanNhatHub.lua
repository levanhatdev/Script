...
local OrionLib = {
	...
	Themes = {
		Default = {
			...
			Second = Color3.fromRGB(255, 0, 255),
...
if not Success then
	warn("\nLe Van Nhat XP Hub - Không thể tải Biểu tượng. Mã lỗi: " .. Response .. "\n")
end	
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if OrionLib.Flags[a] then
			...
			warn("Le Van Nhat XP Hub Trình tải cấu hình - Không thể tìm thấy ", a ,b)
		end
	end)
end
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		local NotificationFrame = SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(25, 25, 25), 0, 10), {
			...
			MakeElement("Stroke", Color3.fromRGB(255, 0, 0), 1.2),
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Le Van Nhat XP Hub"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Le Van Nhat XP Hub"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://12947029414"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://12947029414
